...
```bash
git remote add encore encore://esawit-agritech-platform-upz2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/esawit-agritech-platform-upz2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/esawit-agritech-platform-upz2/settings/integrations/github)
